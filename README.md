...
[![Docker Image Size](https://img.shields.io/docker/image-size/gcorbaz/mybibli/1.18.0?logo=docker&label=image%20size)](https://hub.docker.com/r/gcorbaz/mybibli/tags)
...
**Status:** in production since v1.1.1 (2026-05-14). 10 epics shipped; project is in GH-issue-driven polish mode. Current release: `v1.18.0`. Pre-built images on Docker Hub at [`gcorbaz/mybibli`](https://hub.docker.com/r/gcorbaz/mybibli). See [ROADMAP.md](ROADMAP.md) for what's coming next.
...
Live production install (`v1.18.0`, household NAS, 140+ volumes catalogued and growing):
