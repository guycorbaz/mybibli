...
Ce manuel couvre mybibli version 1.1.3 et ultérieures (le plancher v1.1.0 reste obligatoire pour les nouvelles installations — voir le chapitre Installation pour le contexte du seed-gate).
\end{center}
