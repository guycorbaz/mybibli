...
curl -O https://raw.githubusercontent.com/guycorbaz/mybibli/v1.16.0/docker-compose.yml
curl -O https://raw.githubusercontent.com/guycorbaz/mybibli/v1.16.0/.env.example
cp .env.example .env
\end{lstlisting}
