...
This manual covers mybibli version 1.3.0 and later (the v1.1.0 floor is still enforced for fresh installs — see the Installation chapter for the seed-gate background).
\end{center}
