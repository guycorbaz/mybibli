...
in \texttt{.env}, see chapter~\ref{ch:installation}), the files are
visible directly on the host without needing
...
Edit your \texttt{docker-compose.yml} or \texttt{.env}, set
\texttt{MYBIBLI\_LOG\_LEVEL}, then:
