...
requests, discussions, and any other venue tied to this repository — and also applies
when an individual is officially representing the community in public spaces. Examples of
...
the maintainer, **[@guycorbaz](https://github.com/guycorbaz)**, privately — through the
contact details on his GitHub profile, or by any private channel you already share with
him. **Do not report conduct concerns in a public issue**, and do not use the security
advisory form, which is reserved for vulnerabilities.
...
*A note on scale, in the interest of honesty.* This project is maintained by one person.
There is no moderation team and no appeals board — the maintainer is the whole of it.
That does not weaken the standards above; it means enforcement will be direct and
sometimes blunt, and that a report will be read by exactly one person.
