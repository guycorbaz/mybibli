...
use crate::routes::admin_users::{UsersFilters, render_users_panel};
...
// Story 8-3 users query/form structs (UsersQuery, UsersFilters, CreateUserForm,
// UpdateUserForm, DeactivateForm, ReactivateForm) moved to
// src/routes/admin_users.rs (#391 — Foundation Rule #12 split).
...
// Story 8-3 users templates (AdminUsersPanel, AdminUsersFormCreate,
// AdminUsersRow, AdminUsersFormEdit, AdminUserDeactivateModalTemplate) moved
// to src/routes/admin_users.rs (#391 — Foundation Rule #12 split).
...
// Story 8-3 + 9-14 admin users handlers (admin_users_panel,
// admin_users_create_form, validate_username, admin_users_create,
// admin_users_edit_form, admin_users_deactivate_modal, admin_users_update,
// admin_users_deactivate, admin_users_reactivate) moved to
// src/routes/admin_users.rs (#391 — Foundation Rule #12 split).
...
pub(crate) async fn render_admin(
    state: &AppState,
    session: &Session,
    loc: &'static str,
    uri: &axum::http::Uri,
...
// Users-panel renderers + pagination clamp (MAX_USERS_PAGE, clamp_users_page,
// render_users_panel, render_user_row) moved to src/routes/admin_users.rs
// (#391). `render_panel` below dispatches AdminTab::Users to the imported
// `render_users_panel`.
