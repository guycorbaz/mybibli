...
- [#370](https://github.com/guycorbaz/mybibli/issues/370) — Follow-ups from #26 error-handling pass (Conflict split, `feedback_html_pub` move, typed Internal, OobUpdate sanitize). Non-blocking.
- [#374](https://github.com/guycorbaz/mybibli/issues/374) — Follow-up: #30 sub-items 2+3 + #18 leftover a11y items.
