...
- ✅ AC11 — LOC budget respected: `tests/navbar_role_visibility.rs` is **537 LOC**, `tests/e2e/specs/journeys/navbar-role-visibility.spec.ts` is **140 LOC**. ZERO LOC changes to template / JS / routes / locales. All well under 2000-LOC per-file limit.
...
**New:**
- `tests/navbar_role_visibility.rs` — 7 integration test cases (537 LOC).
