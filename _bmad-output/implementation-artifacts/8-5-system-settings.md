...
- [ ] **Task 5: Templates — panel replacement + three new forms (AC: 1, 2, 3, 4, 9, 10)**
  ...
  - [x] 5.5 Each handler's success response is the updated form fragment (with bumped version number embedded) PLUS an OOB FeedbackEntry targeting `#feedback-list` with `hx-swap-oob="beforeend"` (mirroring the 8-3 admin-users pattern).
