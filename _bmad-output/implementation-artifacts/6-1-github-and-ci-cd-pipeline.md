...
- 2026-04-13 — Commit `ebd7649`: fix 409 artifact-name conflict by collapsing the 3 calls of `_gates.yml` in `ci.yml`/`release.yml` into a single `gates` parent job. Updated docs/ci-cd.md branch-protection check names accordingly (`gates / rust-tests` etc.).
